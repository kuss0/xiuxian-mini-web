...
def build_get_routes(handlers: Mapping[str, Callable]) -> dict[str, Callable]:
    return {
        ...
        "/api/maintenance/retention": handlers["_get_maintenance_retention"],
        ...
        "/api/log-commands": handlers["_get_log_commands"],
...
def build_post_routes(handlers: Mapping[str, Callable]) -> dict[str, PostRoute]:
    return {
        ...
        "/api/maintenance/retention": PostRoute(handlers["_post_maintenance_retention"], needs_payload=True),
        ...
        "/api/log-commands/dispatch": PostRoute(handlers["_post_log_command_dispatch"], needs_payload=True),
